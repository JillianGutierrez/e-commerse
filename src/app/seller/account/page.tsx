...
import { User, Lock, Building2, LogOut, Sparkles } from 'lucide-react'
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-neutral-600 mt-2">Manage your profile and business settings</p>
      </div>
      ...
      <div className="flex gap-1 border-b border-neutral-200">
        ...
        <Button
          ...
          className={activeTab === 'business' ? 'bg-black text-white rounded-none border-b-2 border-black' : 'rounded-none hover:bg-neutral-50'}
        >
        ...
        <Card className="border border-neutral-200 shadow-sm">
          ...
          <CardContent>
            <form onSubmit={updateBusiness} className="space-y-5">
              ...
              <div className="space-y-2">
                <Label className="text-sm font-medium">Business Permit (URL or reference)</Label>
                <Input
