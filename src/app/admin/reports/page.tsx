...
import { BarChart3, Calendar, DollarSign, TrendingUp, ShoppingBag, XCircle, Wallet } from 'lucide-react'
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 mt-1">Platform-wide analytics and insights</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500 mt-1">{report?.summary.totalOrders || 0} total orders</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{report ? formatCurrency(report.summary.totalCommission) : '-'}</div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500 mt-1">Cancelled orders</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{report?.summary.totalSellers || 0}</div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{report?.summary.totalBuyers || 0}</div>
          </CardContent>
        </Card>

        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-slate-600">Couriers</CardTitle>
            <Wallet className="h-4 w-4 text-slate-400" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{report?.summary.totalCouriers || 0}</div>
          </CardContent>
        </Card>
            ...
            {loading ? (
              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={report.salesChartData}>
                  ...
                  />
                  <Line type="monotone" dataKey="sales" stroke="#0f172a" strokeWidth={2} dot={{ fill: '#0f172a', strokeWidth: 2 }} />
                </LineChart>
              </ResponsiveContainer>
            ) : (
              <div className="flex items-center justify-center min-h-[300px]">
                ...
                <div key={order.id} className="flex items-center justify-between rounded-lg border border-slate-200 p-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      {order.buyer ? `${order.buyer.user?.firstName || order.buyer.firstName} ${order.buyer.user?.lastName || order.buyer.lastName}` : 'Unknown'} &bull;{' '}
