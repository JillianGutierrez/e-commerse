        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="p-4 rounded-lg border border-slate-200">
              ...
              <p className="text-sm text-slate-500 mt-1">{session?.user?.status || 'N/A'}</p>
            </div>
            <div className="p-4 rounded-lg border border-slate-200">
              <p className="font-medium">Two-Factor Authentication</p>
              <p className="text-sm text-slate-500 mt-1">Not enabled</p>
            </div>
          </CardContent>
        </Card>
      )}
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-red-600 mt-1">Sign out of your admin account</p>
            </div>
